...
3. Once the app is started. 
 http://localhost:8080/api/v1/currencies -- will retrieve all currencies available.(GET)
 http://localhost:8080/api/v1/currency-converter -- will convert currency from and to.(POST)
 http://localhost:8080/swagger-ui.html  -- will list operations using swagger.
